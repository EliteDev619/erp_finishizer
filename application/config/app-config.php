...
*
*/
// define('APP_BASE_URL', 'http://10.120.173.130:2100/');
define('APP_BASE_URL', 'http://localhost/erp_finishizer/');
...
*/
define('APP_ENC_KEY', '0bd7918310a634b28932b6b05f5af64d');
