...
<!-- <p><?php echo _l('email_template'); ?>: <b>Subscription Payment Succeeded</b></p> إضافة ترجمة اللمسة النهائية -->
<p><?php echo _l('email_template'); ?>: <b><?php echo _l('Subscription_Payment_Succeeded')?></b></p>
<hr />