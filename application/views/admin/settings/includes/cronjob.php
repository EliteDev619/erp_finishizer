    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            <li role="presentation" class="active">
                <!-- <a href="#cron_command" aria-controls="cron_command" role="tab" data-toggle="tab">Command</a> إضافة ترجمة اللمسة النهائية -->
                <a href="#cron_command" aria-controls="cron_command" role="tab" data-toggle="tab"><?php echo _l('Command');?></a>
...
<div class="tab-content mtop15">
    <div role="tabpanel" class="tab-pane active" id="cron_command">
        <div class="alert alert-info tw-mb-0">
            <!-- <span class="bold text-info">CRON COMMAND: wget -q -O- إضافة ترجمة اللمسة النهائية-->
            <span class="bold text-info"><?php echo _l('CRON_COMMAND:wget_-q_-O-'); ?>
                <?php echo site_url('cron/index' . (defined('APP_CRON_KEY') ? '/' . APP_CRON_KEY : '')); ?></span><br />
            <?php if (is_admin()) { ?>
            <!-- <a href="<?php /*echo admin_url('misc/run_cron_manually');*/ ?>">Run Cron Manually</a> إضافة ترجمة اللمسة النهائية-->
            <a href="<?php echo admin_url('misc/run_cron_manually'); ?>"><?php echo _l('Run_Cron_Manually');?></a>
            <?php } ?>
        </div>
    </div>
