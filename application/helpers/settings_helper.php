...
function app_init_settings_tabs()
{
    ...
    $CI->app_tabs->add_settings_tab('e_sign', [
        'name'     => _l('E-Sign'), // تعديلات اللمسة النهائية إضافة ترجمة
    ...
    $CI->app_tabs->add_settings_tab('pusher', [
        'name'     => _l('Pusher.com'), // تعديلات اللمسة النهائية إضافة ترجمة
    ...
    $CI->app_tabs->add_settings_tab('google', [
        'name'     => _l('Google'), // تعديلات اللمسة النهائية إضافة ترجمة
